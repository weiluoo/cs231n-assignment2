...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
    """
    Convenience layer that perorms an affine transform and batch normalize followed by a ReLU
...
def affine_bn_relu_backward(dout, cache):
    ...
    dout, dw, db = affine_backward(dout2, fc_cache)
    return dgamma, dbeta, dout, dw, db


def affine_ln_relu_forward(x, w, b, gamma, beta, ln_param):
    """
    Convenience layer that perorms an affine transform and layer normalize followed by a ReLU
...
def affine_ln_relu_backward(dout, cache):
    """
    Backward pass for the affine-layer normalization-relu convenience layer
    """
